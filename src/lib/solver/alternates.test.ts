 ...
 *
 * This is a TS-only feature — the Python reference solves for one layout — so
 * there is no fixture to replay here. What it pins is the promise the card
...
import { splitGridIntoIslands, canCoolDirectProducer } from "./island";
import { solveIsland } from "./placementSearch";
import type {
  EffectiveBuilding,
  PlacedBuilding,
  Placement,
