 ...
 *
 * Ported from `DowngradeOversizedTests` in the reference solver's
...
import { downgradeOversized, solveIsland } from "../src/solver/placementSearch";
import { simulateIsland, type SimPlacedBuilding } from "../src/solver/simulate";
import type { EffectiveBuilding, Placement, Tile } from "../src/solver/types";
