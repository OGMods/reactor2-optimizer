 ...
 *
 * Not part of the search proper (see docs/SOLVER.md): it exists because a
 * player does not want "the" answer so much as a shortlist — several
 * arrangements usually tie at the top, and which of them is nicest to build is
 * a judgement the solver cannot make.
 *
